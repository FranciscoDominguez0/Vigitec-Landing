  ...
  if (finanzas) {
    ...
    detalleFinancieroHTML = `
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
        ...
        <tr><td style="padding: 10px; border-bottom: 1px solid #ddd;"><strong>Plazo de Financiamiento:</strong></td><td style="padding: 10px; border-bottom: 1px solid #ddd;">${finanzas.anos} a&ntilde;os</td></tr>
    ...
    detalleFinancieroHTML = `
      ...
      <p style="color: #555; font-size: 14px; font-style: italic;">No aplica para c&aacute;lculo de financiamiento autom&aacute;tico (Servicio personalizado o a&ntilde;os no v&aacute;lidos).</p>
    `;
  }
