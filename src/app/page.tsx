...
export default function Home() {
  return (
    <>
      ...
      <section className="relative overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-32 bg-[url('/assets/img/hero/servicios_bg.png')] bg-cover bg-center bg-no-repeat bg-fixed">
        {/* Fondo Decorativo Abstracto */}
        <div className="absolute top-0 right-0 w-1/2 h-full bg-primary rounded-l-[100px] opacity-50 hidden lg:block"></div>
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 lg:pr-12 text-center lg:text-left mb-16 lg:mb-0">
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-display font-extrabold text-white leading-[1.1] mb-6 tracking-tight mt-10">
              Protegemos Lo <br />
              <span className="text-accent">Que Más Importa.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <Link href="/cotizacion" className="w-full sm:w-auto bg-accent text-white px-8 py-4 rounded-full font-semibold hover:bg-accentHover hover:shadow-red-glow transition-all duration-300 flex items-center justify-center">
                Comenzar Ahora
              </Link>
              <Link href="/servicios" className="w-full sm:w-auto bg-transparent text-white border border-gray-600 px-8 py-4 rounded-full font-semibold hover:border-white hover:bg-white/5 transition-all duration-300 flex items-center justify-center">
                Nuestros Servicios
              </Link>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#111111]">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold text-white mb-6 tracking-tight">Expertos en Seguridad y Tecnología</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
            ...
            {/* Item 1 */}
            <div className="border-l-2 border-gray-800 hover:border-accent pl-8 py-2 transition-colors duration-500 group">
              <div className="flex items-center space-x-5 mb-5">
                <div className="text-gray-500 group-hover:text-accent transition-colors duration-500">
            ...
            <div className="border-l-2 border-gray-800 hover:border-accent pl-8 py-2 transition-colors duration-500 group">
              <div className="flex items-center space-x-5 mb-5">
                ...
                <h3 className="text-2xl font-bold text-white font-display tracking-wide">Mantenimiento</h3>
              </div>
              <p className="text-gray-400 font-light leading-relaxed text-sm">
            ...
            <div className="border-l-2 border-gray-800 hover:border-accent pl-8 py-2 transition-colors duration-500 group">
              <div className="flex items-center space-x-5 mb-5">
                ...
                <h3 className="text-2xl font-bold text-white font-display tracking-wide">Cámaras</h3>
              </div>
              <p className="text-gray-400 font-light leading-relaxed text-sm">
            ...
            <div className="border-l-2 border-gray-800 hover:border-accent pl-8 py-2 transition-colors duration-500 group">
              <div className="flex items-center space-x-5 mb-5">
                ...
                <h3 className="text-2xl font-bold text-white font-display tracking-wide">Reparaciones</h3>
              </div>
              <p className="text-gray-400 font-light leading-relaxed text-sm">
